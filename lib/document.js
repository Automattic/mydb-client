...
/**
 * Performs the object mutation.
 *
 * @api private
 */

Document.prototype.handleOp = function (mod, implicit) {
  ...
  if (mod.$pull) {
    var self = this;
    for (var key in mod.$pull) {
      if (mod.$pull.hasOwnProperty(key)) {
        (function (k) {
          var m = { $pull: {} };
          m.$pull[key] = mod.$pull[key];
          try {
